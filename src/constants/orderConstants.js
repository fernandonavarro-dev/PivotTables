...
export const OPEN_ORDER_LIST_REQUEST = 'OPEN_ORDER_LIST_REQUEST';
export const OPEN_ORDER_LIST_SUCCESS = 'OPEN_ORDER_LIST_SUCCESS';
export const OPEN_ORDER_LIST_FAIL = 'OPEN_ORDER_LIST_FAIL';
