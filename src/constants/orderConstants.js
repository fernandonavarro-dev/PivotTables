...
export const OPEN_ORDER_LIST_REQUEST = 'ORDER_LIST_REQUEST';
export const OPEN_ORDER_LIST_SUCCESS = 'ORDER_LIST_SUCCESS';
export const OPEN_ORDER_LIST_FAIL = 'ORDER_LIST_FAIL';
